...
-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('INSTALLATION', 'MOUNTING', 'MAINTENANCE', 'INSPECTION', 'RELOCATION');
...
CREATE TABLE "holdings" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "assetType" "AssetType" NOT NULL DEFAULT 'RENTED',
    "vendorId" TEXT,
    "images" TEXT[],
...
-- CreateTable
CREATE TABLE "task_execution_photos" (
    "id" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    "viewType" TEXT,
    "uploadedByUserName" TEXT,
    ...
    CONSTRAINT "task_execution_photos_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "suggestion_photos" (
    "id" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    "uploadedByUserName" TEXT,
    "uploadedById" TEXT,
    ...
    CONSTRAINT "suggestion_photos_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ownership_contracts_vendorId_holdingId_status_idx" ON "ownership_contracts"("vendorId", "holdingId", "status");
...
-- CreateIndex
CREATE INDEX "invoice_items_bookingId_idx" ON "invoice_items"("bookingId");
...
-- CreateIndex
CREATE UNIQUE INDEX "location_suggestions_holdingId_key" ON "location_suggestions"("holdingId");
...
-- AddForeignKey
ALTER TABLE "holding_photos" ADD CONSTRAINT "holding_photos_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "holding_photos" ADD CONSTRAINT "holding_photos_holdingId_fkey" FOREIGN KEY ("holdingId") REFERENCES "holdings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "task_execution_photos" ADD CONSTRAINT "task_execution_photos_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "task_execution_photos" ADD CONSTRAINT "task_execution_photos_executionId_fkey" FOREIGN KEY ("executionId") REFERENCES "task_executions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "inspection_photos" ADD CONSTRAINT "inspection_photos_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_liabilityLedgerId_fkey" FOREIGN KEY ("liabilityLedgerId") REFERENCES "ledgers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "location_suggestions" ADD CONSTRAINT "location_suggestions_holdingId_fkey" FOREIGN KEY ("holdingId") REFERENCES "holdings"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "suggestion_photos" ADD CONSTRAINT "suggestion_photos_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "suggestion_photos" ADD CONSTRAINT "suggestion_photos_suggestionId_fkey" FOREIGN KEY ("suggestionId") REFERENCES "location_suggestions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
